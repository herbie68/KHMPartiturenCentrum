...
public class ScoreModel
{
	...
	public bool MP3SOL1 { get; set; }
	public bool MP3SOL2 { get; set; }
	...
	public bool MP3UITVVoice { get; set; }
	public bool MP3SOL1Voice { get; set; }
	public bool MP3SOL2Voice { get; set; }
	...
	public int MP3SOL1Int { get; set; }
	public int MP3SOL2Int { get; set; }
	public int MP3T1Int { get; set; }
	public int MP3T2Int { get; set; }
	public int MP3TOTInt { get; set; }
	public int MP3UITVInt { get; set; }
	public int MP3B1VoiceInt { get; set; }
	public int MP3B2VoiceInt { get; set; }
	public int MP3SOL1VoiceInt { get; set; }
	public int MP3SOL2VoiceInt { get; set; }
	public int MP3T1VoiceInt { get; set; }
	public int MP3T2VoiceInt { get; set; }
	public int MP3TOTVoiceInt { get; set; }
	public int MP3UITVVoiceInt { get; set; }
